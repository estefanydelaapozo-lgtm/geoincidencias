-- Script SQL simplificado para crear las tablas en phpMyAdmin
-- Copia y pega esto en la pestaña "SQL" de phpMyAdmin

-- 1. Primero elimina tablas si existen (para evitar errores)
...
(2, 'Piso 1', 'Oficinas administrativas', -2.900200, -79.005800, 1),
(3, 'Piso 2', 'Area tecnica y sistemas', -2.900300, -79.005700, 1),
(4, 'Piso 3', 'Gerencia y salas de reuniones', -2.900400, -79.005600, 1),
(5, 'Bodega', 'Almacen y logistica', -2.900500, -79.005500, 1),
(6, 'Parqueadero', 'Zona de parqueo vehicular', -2.900600, -79.005400, 1),
(7, 'Sala de Servidores', 'Centro de datos principal', -2.900700, -79.005300, 1),
(8, 'Cafeteria', 'Area de descanso y comedor', -2.900800, -79.005200, 1);
